      ...
      >
        <div class="ml-14 w-full lg:w-4/6">
          ...
          <div class="bg-white shadow-md rounded my-6">
            ...
            <!--Modal-->
   <div v-if="modal" class="main-modal fixed w-full inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster" style="background: rgba(0,0,0,.7);">
			...
			<div class="modal-content py-4 text-left px-6">
				...
				<div class="my-5 mr-5 ml-5 flex justify-center">
                    <form class="w-full">
                        <div class="">
                            <div class="">
                                <label for="names" class="text-md text-gray-600">Username</label>
                            </div>
                            <div class="">
                                <input type="text" name="names" class="h-3 p-6 w-full border-2 border-gray-300 mb-5 rounded-md">
                            </div>
                            <div class="">
                            ...
                            <div class="">
                                <label for="user_type" class="text-md text-gray-600">User Type</label>
                            </div>
                            <div class="">
                                <select class="h-3 p-6 w-full border-2 border-gray-300 mb-5 rounded-md">
				...
				<div class="flex justify-end pt-2 space-x-14">
					...
					<button
						class="px-4 bg-blue-500 p-3 ml-3 rounded-lg text-white hover:bg-teal-400">Save</button>
				</div>
			</div>
		</div>
	</div>
